        ...
        <div className="space-y-6 border-t border-muted pt-8">
          ...
          <div>
            ...
            <Tabs defaultValue="preview" className="w-full">
              ...
              <TabsContent value="code">
                <div className="rounded-md bg-muted">
                  <CopyBlock text={mobileExample} language="tsx" showLineNumbers theme={customTheme} codeBlock />
                </div>
              </TabsContent>
            </Tabs>
          </div>
          ...
          <div className="pt-4">
            ...
            <Tabs defaultValue="preview" className="w-full">
              ...
              <TabsContent value="code">
                <div className="rounded-md bg-muted">
                  <CopyBlock text={indicatorExample} language="tsx" showLineNumbers theme={customTheme} codeBlock />
                </div>
              </TabsContent>
            </Tabs>
          </div>
